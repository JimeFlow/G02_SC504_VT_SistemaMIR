...
-- REVISAR DOCUMENTO DE LA NOMENCLATURA Y TODO EL SCRIPT DETALLADAMENTE (QUE ESTE BIEN ESCRITO)
...
CREATE TABLE FIDE_ESTADOS_TB (
    Estado_Id NUMBER CONSTRAINT FIDE_ESTADOS_TB_Estado_ID_PK PRIMARY KEY,
